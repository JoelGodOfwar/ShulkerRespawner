package com.github.joelgodofwar.sr.common.error;
...
import com.github.joelgodofwar.sr.common.collections.ExpireHashMap;
import com.github.joelgodofwar.sr.common.error.Report.ReportBuilder;
import com.github.joelgodofwar.sr.common.reflect.PrettyPrinter;
import com.github.joelgodofwar.sr.util.Ansi;
import com.github.joelgodofwar.sr.util.StrUtils;
...
public class DetailedErrorReporter implements ErrorReporter {
	...
	public DetailedErrorReporter(Plugin plugin, String prefix, String supportURL, int maxErrorCount, Logger logger) {
		...
		this.logger = logger;
		this.sr = (ShulkerRespawner) plugin;
	}
	...
	public void reportDetailed(Object sender, Report report) {
		...
		// And plugin
		if (plugin != null) {
			writer.println("Version: " + sr.getName() + " v" + sr.getDescription().getVersion());
			String jarfilename = sr.getjarfilename();
		...
		FileConfiguration config = sr.getConfig();
	 ...
	 * @param prefix - prefix asrd to every line in the text.
	...
	/**
	 * Retrieve the support URL that will be asrd to all detailed reports.
	 * @return Support URL.
	 */
	...
	/**
	 * Set the support URL that will be asrd to all detailed reports.
