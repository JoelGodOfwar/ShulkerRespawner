...
public class VersionChecker {
	...
	public VersionChecker(ShulkerRespawner plugin, int projectID, String githubURL) {
		this.sr = plugin;
	...
	public boolean checkForUpdates() throws Exception {
		...
		sr.LOGGER.debug(ChatColor.RED + "currentVersion=" + currentVersion);
		sr.LOGGER.debug(ChatColor.RED + "releaseVersion=" + releaseVersion);
		sr.LOGGER.debug(ChatColor.RED + "developerVersion=" + developerVersion);
